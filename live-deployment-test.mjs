...
async function verify(){
  ...
  const core=["training-images-feature.js","training-hub-feature.js","training-image-manifest.json","app.js","styles.css","update-feature.js","index.html","install.html","manifest.json","sw.js","exercise-images-feature.js","exercise-image-spec.json","exercise-image-manifest.json"];
