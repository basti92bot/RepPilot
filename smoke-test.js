...
if (install) {
  ...
  if (/display-mode:\s*standalone/.test(install) &&
      ...
      /location\.replace\(['"]\.\/\?launch=v11\.8\.112['"]\)/.test(install)) {
  ...
  if (/navigator\.serviceWorker\.register\(['"]\.\/sw\.js\?v=11\.8\.112['"]/.test(install)) {
...
if (auth) {
  ...
  if (/auth\.js\?v=11\.8\.112/.test(index) && /auth\.js\?v=11\.8\.112/.test(sw)) {
...
if (auth && index && sw) {
  ...
  if (/strength-test-feature\.js\?v=11\.8\.112/.test(index) &&
      /strength-test-feature\.js\?v=11\.8\.112/.test(sw)) {
...
if (tour) {
  ...
  if (/app-tour-feature\.js\?v=11\.8\.112/.test(index) &&
      /app-tour-feature\.js\?v=11\.8\.112/.test(sw)) {
...
try {
  ...
  if (index.includes('history-simple-feature.js?v=11.8.112') &&
      sw.includes('history-simple-feature.js?v=11.8.112')) {
...
if (sw) {
  if (sw.includes("manifest.json") && sw.includes("icon-192.png?v=11.8.112") && sw.includes("icon-512.png?v=11.8.112")) {
