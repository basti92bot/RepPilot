...
function finish(){active.finishedAt=new Date().toISOString();const h=history();h.push(active);save(h);localStorage.setItem("reppilot-history-view-v1","strength");active=null;renderHistory();renderHome();show("history")}
