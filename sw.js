const CACHE="reppilot-v11-8-84";
const VERSION="11.8.84";
const ASSETS=[
  "./index.html",
  "./styles.css?v=11.8.84",
  "./header-fix.css?v=11.8.27",
  "./manifest.json?v=11.8.84",
  "./reppilot-muscleman-logo-v11.8.26.png?v=11.8.84",
  "./reppilot-app-icon-v11.8.84.png",
  "./auth.js?v=11.8.8",
