const CACHE="reppilot-v11-8-83";
const VERSION="11.8.83";
const ASSETS=[
  "./index.html",
  "./styles.css?v=11.8.83",
  "./header-fix.css?v=11.8.27",
  "./manifest.json?v=11.8.83",
  "./reppilot-muscleman-logo-v11.8.26.png?v=11.8.83",
  "./reppilot-app-icon-v11.8.83.png",
  "./auth.js?v=11.8.8",
