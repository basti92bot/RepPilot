const CACHE="reppilot-v11-7";const ASSETS=["./","./index.html","./styles.css?v=11.7","./app.js?v=11.7","./manifest.json","./icon-192.png","./icon-512.png","./stretch-anatomy-v11.7.png?v=11.7"];
