const CACHE="reppilot-v11-7-1";const ASSETS=["./","./index.html","./styles.css?v=11.7.1","./app.js?v=11.7.1","./manifest.json","./icon-192.png","./icon-512.png","./stretch-anatomy-v11.7.png?v=11.7.1"];
