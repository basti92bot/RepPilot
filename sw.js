const CACHE="reppilot-v11-8-82";
const VERSION="11.8.82";
const ASSETS=[
  "./index.html",
  "./styles.css?v=11.8.82",
  "./header-fix.css?v=11.8.27",
  "./manifest.json?v=11.8.82",
  "./reppilot-muscleman-logo-v11.8.26.png?v=11.8.82",
  "./reppilot-app-icon-v11.8.82.png",
  "./auth.js?v=11.8.8",
